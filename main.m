...
trave.f_lim = trave.luce*1000/720;

% interassi di calcolo
interassi = 2:.2:3;   % [m] interassi di calcolo

% dati soletta
trave.hc = 130;  % [mm] altezza della soletta in cls+lamiera
h_lam = 75; % [mm] altezza della lamiera
%trave.carichi.PP = (trave.hc - h_lam/2)*1e-3 * 25;
trave.carichi.PP = 1.88;
...
ris = struct('Interasse', [], 'Profilo', [], 'Peso', [], 'P_sup', [], 'Efficienza', [],'yn_el', [], 'Rj', [], 'fa', [], 'fid', [], 'Frequenza', [], 'Rf', [], 'Med', [], 'Mpl', [], 'Rm', []);
